...
public class ReadingsTCs extends TestBase {
	...
	String EnglishfilePath = configInputData.ReadingexcelSheetEnglishPath;
	String ArabicfilePath = configInputData.ReadingexcelSheetArabicPath;

	@DataProvider(name = "Steps")
	public Object[][] stepsData() {

		return ExcelReader.loadTestData(EnglishfilePath, "Steps");
	}
	...
	public Object[][] bloodreading() {
		...
		return ExcelReader.loadTestData(EnglishfilePath, "Blood Sugar");
	...
	public Object[][] weightreading() {
		...
		return ExcelReader.loadTestData(EnglishfilePath, "Weight");
	}

	@DataProvider(name = "Oxygen Level")
	public Object[][] oxygenleve() {

		return ExcelReader.loadTestData(EnglishfilePath, "Oxygen Level");
	}

	@DataProvider(name = "Blood Pressure")
	public Object[][] Blood_Pressure() {

		return ExcelReader.loadTestData(EnglishfilePath, "Blood Pressure");
	}

	@DataProvider(name = "Heart Rate")
	public Object[][] Heart_Rate() {

		return ExcelReader.loadTestData(EnglishfilePath, "Heart Rate");
	}

	@DataProvider(name = "Temperature")
	public Object[][] Temperature() {

		return ExcelReader.loadTestData(EnglishfilePath, "Temperature");
	}

	@DataProvider(name = "Respiration Rate")
	public Object[][] Respiration_Rate() {

		return ExcelReader.loadTestData(EnglishfilePath, "Respiration Rate");
	}

	@DataProvider(name = "BMI")
	public Object[][] BMI() {

		return ExcelReader.loadTestData(EnglishfilePath, "BMI");
	}

	@DataProvider(name = "Bones Mass")
	public Object[][] Bones_Mass() {

		return ExcelReader.loadTestData(EnglishfilePath, "Bones Mass");
	}

	@DataProvider(name = "Muscle Mass")
	public Object[][] Muscle_Mass() {

		return ExcelReader.loadTestData(EnglishfilePath, "Muscle Mass");
	}

	@DataProvider(name = "Body Fat")
	public Object[][] Body_Fat() {

		return ExcelReader.loadTestData(EnglishfilePath, "Body Fat");
	}

	@DataProvider(name = "Body Water")
	public Object[][] Body_Water() {

		return ExcelReader.loadTestData(EnglishfilePath, "Body Water");
	}

	@DataProvider(name = "Visceral Fat Rating")
	public Object[][] Fasceral_Fat() {

		return ExcelReader.loadTestData(EnglishfilePath, "Visceral Fat Rating");
	}
	...
	@Test(priority = 3, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Steps")
	...
	@Test(priority = 5, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Oxygen Level")
	...
	@Test(priority = 6, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Blood Pressure")
	...
	@Test(priority = 7, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Heart Rate")
	...
	@Test(priority = 8, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Temperature")
	...
	@Test(priority = 9, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Respiration Rate")
	...
	@Test(priority = 10, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "BMI")
	...
	@Test(priority = 11, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Bones Mass")
	...
	@Test(priority = 12, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Muscle Mass")
	...
	@Test(priority = 13, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Body Fat")
	...
	@Test(priority = 14, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Body Water")
	...
	@Test(priority = 15, enabled = false, dependsOnMethods = "ShowAllReadingsCells", dataProvider = "Visceral Fat Rating")
